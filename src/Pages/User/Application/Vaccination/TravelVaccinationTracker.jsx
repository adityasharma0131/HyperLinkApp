...
const TravelVaccinationTracker = () => {
  const [isDropdownOpen, setIsDropdownOpen] = useState(false);
  const [selectedOption, setSelectedOption] = useState("TRAVEL VACCINES"); // ✅ Default changed
  ...
  const upcomingVaccines = [
    {
      ...
      name: "Yellow Fever",
      description:
        "Recommended for travel to certain African and South American countries",
      date: "05 Oct 2025",
      brand: "Stamaril",
      type: "ESSENTIAL",
      doses: [{ number: 1, status: "", date: "05 Oct 2025" }],
    },
  ];
  ...
  const completedVaccines = [
    {
      ...
      name: "Typhoid",
      description:
        "Prevents typhoid fever — important for travel to Asia, Africa",
      date: "10 Mar 2025",
      brand: "Typhim Vi",
      progress: "1 (out of 1)",
      type: "ESSENTIAL",
...
export default TravelVaccinationTracker;
